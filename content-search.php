          ...
          <div class="list-group">
            <div class="list-group-item">
              ...
              <div class="row-content">
                <div class="list-group-item-heading"> <a href="#" title="sintret"> <small> <?php echo __( 'Author','stackdesign'); ?>:
                  <?php the_author(); ?>
                  </small> </a> </div>
                <small> <i class="glyphicon glyphicon-time"></i> <?php echo get_the_date('F j, Y g:i a'); ?> <br>
                <i class="glyphicon  glyphicon-eye-open"></i> <?php echo getPostViews(get_the_ID()); ?> <br>
                <span class="explore"><i class="glyphicon glyphicon-education"></i> <a href="#">Number                                           posts
